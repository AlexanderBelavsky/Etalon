    ...
    <script>
            ...
            /* prselected[value.idrequest] = [];
             prtables[value.idrequest] = $('#practice_' + value.idrequest).DataTable({
                 ...
                 "drawCallback": function () {
                     var cb = $('#practice_' + value.idrequest).find('input[type="checkbox"]');
                     cb.attr({
                         checkboxClass: 'checkbox_square-blue',
                         radioClass: 'radio_square-blue',
                         increaseArea: '20%' // optional
                     });
        ...
        function fillForm() {
            ...
            /*oTable = $('#tstudents').DataTable({
                ...
                "drawCallback": function () {
                    $('#tstudents').find('input[type="checkbox"]').not('.selectall').attr({
                        checkboxClass: 'checkbox_square-blue',
                        radioClass: 'radio_square-blue',
                        increaseArea: '20%' // optional
                    });
                    ...
                    $('.selectall').on('ifChecked', function () {
                        $('#tstudents').find('input[type="checkbox"]').not('.selectall').attr('checked', true);
                    });
                    $('.selectall').on('ifUnchecked', function () {
                        $('#tstudents').find('input[type="checkbox"]').not('.selectall').attr('unchecked', false);
                    });
                    $('#tstudents').find('input[type="checkbox"]').not('.selectall').on('change', function () {
                        var id = this.id;
                        var index = $.inArray(id, selected);
                        ...
                        if ($('#tstudents').find('input[type="checkbox"]').not('.selectall').length === $('#tstudents').find('input[type="checkbox"]:checked').not('.selectall').length) {
                            $('.selectall').prop('checked', true).attr('update');
                        }
                        else {
                            $('.selectall').prop('checked', false).attr('update');
                        }
                    });
                    if ($('#tstudents').find('input[type="checkbox"]').not('.selectall').length === $('#tstudents').find('input[type="checkbox"]:checked').not('.selectall').length) {
                        $('.selectall').prop('checked', true).attr('update');
                          ...
                          <div class="panel-body">
                              <div class="row">
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                      ...
                                      <a href="#myModal8" class="btn btn-primary" data-toggle="modal">Создать заявку</a>
                                                              ...
                                                              <div class="panel panel-default">
                                                                  ...
                                                                  <div class="panel-body">
                                                                      <form class="form-horizontal"
                                                                            role="form" action="/practice/addRequestHOP"
                                                                            id="add_Request"
                                                                            method="post">
                                                                          <div class="form-group">
                                                                          ...
                                                                          <div class="form-group">
                                                                              ...
                                                                              <div class="col-sm-10">
                                                                                  <select id="faculties1" class="form-control"
                                                                                          name="faculty">
                                                                          ...
                                                                          <div class="form-group">
                                                                              ...
                                                                              <div class="col-sm-10">
                                                                                  <select id="specs1" name="speciality"
                                                                                          class="form-control">
